...
while ( rs.next() ) 
{ 
jComboBox1.addItem(new WarehouseItem(rs.getInt(1), rs.getString(2) ) ); 
 ...
 public void load()
    {
        ...
        try {
            ...
            while(Rs.next()){
               ...
               model.addRow(new Object[]{id,productname,description,warehouse,brand,costprice,retailprice,qty,status});  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {   
           ...
           WarehouseItem item = (WarehouseItem)jComboBox1.getSelectedItem();
          ...
          String status = txtstatus.getSelectedItem().toString();
            ...
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/javapos","root","");
          insert = con1.prepareStatement("insert into product (productname,description,warehouse,brand,costprice,retailprice,qty,barcode,status)values(?,?,?,?,?,?,?,?,?)");
        //    insert = con1.prepareStatement("insert into products(productname,description,warehouse)values(?,?,?)");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int selectedIndex = jTable1.getSelectedRow();
            ...
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/javapos","root","");
            insert = con1.prepareStatement("update warehouse set name= ?,status= ? where id= ?");
            insert.setString(1,name);
  ...
  // Saving code here
            ...
            Class.forName("com.mysql.jdbc.Driver");
            con1 = DriverManager.getConnection("jdbc:mysql://localhost/javapos","root","");
            insert = con1.prepareStatement("delete from warehouse where id = ?");
